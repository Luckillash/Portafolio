...
export default function Cibersecurity () {
    ...
    const CLASSNAME_GRID = "card div" + 2

    const CLASSNAME_FILTER = "filter" + 2

    const ID_FILTER = "noise-filter" + 2

    const ID_CLIP = "rounded-clip" + 2
    ...
    return (
        ...
        <div className={CLASSNAME_GRID + " gap-2"}>
            ...
            <h2 className="text-3xl font-bold">Técnico en Ciberseguridad</h2>

            <p className="text-lg">¡Puedo ver lo que haces en el baño!<br/>Pillín.</p>
